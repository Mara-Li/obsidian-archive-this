...
import { ValidTransformation, type FileStats, type OverridePath } from "../src/interfaces";
import { parseKeys, replacePath } from "../src/replacePath";
...
describe("replacePath", () => {
	...
	test("should replace path with frontmatter key", () => {
		const archivePath = replacePath("inbox/2023-01-01/file.md", overrides, fileStat, { date: "2023-01-01" });
